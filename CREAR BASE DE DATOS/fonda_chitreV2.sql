...
INSERT INTO `clientes` (`idcliente`, `numerodecliente`, `direcciondeenvio`, `saldo`, `limitedecredito`, `descuento`, `idcomida`, `idpedido`) VALUES
	(1, '28', 'colon', 0, 21, 5, 708, 1),
	(2, '35', 'alta gracia', 3, 21, 5, 709, 2),
	(3, '36', 'ave. la  paz ', 1, 21, 5, 710, 3),
	(4, '45', 'cordoba', 1, 21, 5, 711, 4),
	(5, '22', 'villa dolores', 1, 21, 5, 712, 5),
	(6, '24', 'san martin', 6, 21, 5, 713, 6),
	(7, '50', 'el paso', 0, 21, 5, 714, 7);
...
-- Dumping data for table fonda_chitre.comidas: ~7 rows (approximately)
/*!40000 ALTER TABLE `comidas` DISABLE KEYS */;
INSERT INTO `comidas` (`idcomida`, `numerodecomida`, `serviciodelivery`, `promocion`, `descripcion`, `iddelivery`, `created_at`) VALUES
	(708, 'n1', '45', '2x1', 'arroz mixto', 1, NULL),
	(709, 'n2', '46', '-20%', 'sancocho', 2, NULL),
	(710, 'n3', '47', NULL, 'ensalada', 3, NULL),
	(711, 'n4', '48', '2x1', 'chichas', 4, NULL),
	(712, 'n5', '49', '-50%', 'mariscos', 5, NULL),
	(713, 'n6', '50', NULL, 'carnes', 6, NULL),
	(714, 'n7', '51', '2x1', 'tamales', 7, NULL);
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  `numerodecliente` decimal(20,0) NOT NULL,
  `direcciondeenvio` varchar(45) NOT NULL,
...
INSERT INTO `pedidos` (`idpedido`, `numerodecliente`, `direcciondeenvio`, `fechadepedido`, `cantidad`, `iddelivery`) VALUES
	(1, 28, 'colon', '2021-07-30 12:53:40', 2, 1),
	(2, 35, 'alta gracia', '2021-07-30 13:30:00', 1, 2),
	(3, 36, 'ave. la  paz ', '2021-07-30 14:00:00', 1, 3),
	(4, 45, 'cordoba', '2021-07-30 14:30:10', 2, 4),
	(5, 22, 'villa dolores', '2021-07-30 14:50:20', 1, 5),
	(6, 24, 'san martin', '2021-07-30 16:05:00', 2, 6),
	(7, 50, 'el paso', '2021-07-30 16:25:00', 1, 7);
